...
public class Main {
    public static void main(String[] args) {
        ...
        double first = persons.stream()
                .filter(person -> person.getAge() >= 18)
                .count();
        System.out.println("Количество совершеннолетних: " + first);

        List<String> second = persons.stream()
        ...
        System.out.println("Список работоспособных: " + third);
    }
}